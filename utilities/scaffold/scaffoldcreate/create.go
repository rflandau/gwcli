...
func NewCreateAction(aliases []string, singular string,
	...
	cmd := treeutils.NewActionCommand(
		...
		func(c *cobra.Command, s []string) {
			...
			// get field flags
			// TODO should validation be in updateFFF?
			// Should all fail on one validation issue? Or do we return invalid []string?
			// Will this be an issue in SetArgs?
			...
			fmt.Printf("field map after parse: %#v\n", fields) // TODO remove me
